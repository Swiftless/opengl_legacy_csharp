...
public class Program
{
    ...
    private static void OnLoad()
    {
        ...
        openGLApi.TexParameter(GLEnum.Texture2D, GLEnum.TextureWrapS, (int)GLEnum.Clamp);
        openGLApi.TexParameter(GLEnum.Texture2D, GLEnum.TextureWrapT, (int)GLEnum.Clamp);
