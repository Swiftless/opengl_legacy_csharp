...
public class Program
{
    ...
    private static int fogType = (int)GLEnum.Exp2;
    ...
    private static void OnRender(double obj)
    {
        ...
        openGLApi.Fog(GLEnum.FogMode, fogType);
        ...
        openGLApi.Fog(GLEnum.FogStart, fogStart);
        openGLApi.Fog(GLEnum.FogEnd, fogEnd);
        ...
        openGLApi.Rotate(-60f, 1, 1, 0); // Rotate everything -60 degrees on the X and Y axis, to show off multiple sides of the cube
    ...
    private static void OnKeyDown(IKeyboard keyboard, Key key, int arg3)
    {
        ...
        if (key == Key.Number1)
        {
            fogType = (int)GLEnum.Linear;
        }

        if (key == Key.Number2)
        {
            fogType = (int)GLEnum.Exp;
        }

        if (key == Key.Number3)
        {
            fogType = (int)GLEnum.Exp2;
        }
